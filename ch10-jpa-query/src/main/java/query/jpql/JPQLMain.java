...
*/
    ...
    public static void jpqlPathExpression(EntityManager em) {
        ...
        * */
        ...
        //묵시적 내부 조인, 실제 SQL 쿼리를 보면 inner join을 실행함
        //외부 조인 필요 시, JPQL 쿼리문에 직접 작성하면 된다.
        String 단일값연관필드 = "SELECT o.member FROM Order o";

        //묵시적 내부 조인
        //컬렉션 연관 필드를 통한 경로 탐색 필요 시, 별칭을 부여하여 탐색할 수 있다.
